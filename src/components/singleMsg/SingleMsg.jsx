...
const SingleMsg = ({ data, owner }) => {
  ...
  return (
    <div className="relative max-w-[50%] break-word pb-4 pl-1.5 pt-1 pr-1 h-auto  min-w-16 rounded-md" style={isOwner ? { alignSelf: "end", backgroundColor: theme.primary, color: "white" } : { alignSelf: "start", backgroundColor: "#D9D9D9",color:"black" }}>
